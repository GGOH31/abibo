...
function mainCard() {
  ...
  h21.textContent = "Chambres et Suites";
...
function CreateCard(ele) {
  ...
  img14.src = "./icons/room-service.svg";
  img14.alt = "Bathroom";
  img14.width = 27;
